...
export const projects = [
    {
        title: "LabEddit",
        image: labeddit,
        description: "Labeddit é um projeto desenvolvido durante o Bootcamp Web Full-Stack da Labenu, de uma pequena rede social onde possibilita a iteração entre pessoas através de pequenas postagens, comentários em texto e reações de like(gostei) ou dislike (não gostei).",
        technologies: [
            "react", "javascript", "html5", "css3"
        ],
        repositorie: "https://github.com/silvaviniciuss/labeddit-frontend",
        deploy: "https://labeddit-vinicius.surge.sh/",
        stack: "Front-end"
    },
    {
        title: "LabEddit",
